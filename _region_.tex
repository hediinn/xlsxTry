\message{ !name(sample2e.tex)}% This is a sample LaTeX input file.  (Version of 12 August 2004.)
%
...
\message{ !name(sample2e.tex) !offset(-3) }
...
\message{ !name(sample2e.tex) !offset(-209) }
